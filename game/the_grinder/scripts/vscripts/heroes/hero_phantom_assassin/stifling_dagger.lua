...
LinkLuaModifier("modifier_imba_stifling_dagger_silence", "heroes/hero_phantom_assassin/stifling_dagger", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_imba_stifling_dagger_dmg_reduction", "heroes/hero_phantom_assassin/stifling_dagger", LUA_MODIFIER_MOTION_NONE)
